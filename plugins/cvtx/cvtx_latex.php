...
/*    $out = str_replace(array('&nbsp;', '&amp;', '&#8211;', '&ndash;', '&mdash;', '&#8212;'),
    ...
    $rules = array(array('search'  => array('<strong>', '</strong>'),
                   ...
                   array('search'  => array('<div>', '</div>'),
                         'replace' => array('', "\n")),
                   array('search'  => array('<span class="color-red">', '</span>'),
                         'replace' => array('\textcolor{rot}{', '}')),
                   array('search'  => array('<span class="color-lila">', '</span>'),
                         'replace' => array('\textcolor{lila}{', '}')),
                   array('search'  => array('<span class="color-grau">', '</span>'),
                         'replace' => array('\textcolor{grau}{', '}')),
                   array('search'  => array('<span class="color-green">', '</span>'),
                         'replace' => array('\textcolor{green}{', '}')),
