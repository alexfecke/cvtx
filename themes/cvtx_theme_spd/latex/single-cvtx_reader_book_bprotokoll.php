...
\begin{linenumbers}
<?php endif; ?>
\addcontentsline{toc}{subsection}{\protect \hspace{2.3em} \textbf{<?php cvtx_kuerzel($item); ?>} \hfill \textbf{<?php cvtx_antragsteller($item); ?>} \\ <?php cvtx_titel($item); ?> \\ \textit{<?php cvtx_spd_result($item); ?>}}
...
\cell{\begin{myLN}
<?php endif; ?>
\textbf{<?php cvtx_spd_result($item); ?>}\\
\newline
