...
<?php get_header(); ?>
    <div class="inner">
        <h1 class="page-title"><?php printf( __( 'Results for: %s', 'cvtx_theme' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
                ...
                <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
    				...
    				<div class="entry">
        				...
        				if ($post->post_type == 'cvtx_antrag'):?>
        				    <?php the_excerpt(__('Read the rest of this entry &raquo;', 'cvtx_theme')); ?>
        				<?php else: ?>
